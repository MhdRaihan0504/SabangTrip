        ...
        <div class="bg-[#EEE9DA] p-6 rounded shadow-lg w-full">
            ...
            <form action="/register" method="POST" class="flex flex-col items-center">
                ...
                <div class="mb-4 w-2/3 ">
                    <input class="shadow rounded-2xl bg-[#265073] appearance-none border w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline" id="nama" name="nama" type="text" placeholder="Nama">
                </div>
                <div class="mb-4 w-2/3 ">
                ...
                <div class="text-center">
                    Sudah punya akun? <a href="/login" class="font-bold hover:text-blue-700">Masuk</a>
                </div>
            </form>
        </div>
    </div>
